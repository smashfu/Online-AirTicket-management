          ...
          <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-lg p-lg-0" aria-labelledby="navbarLandings">
                <div class="row mx-lg-0">
                  <div class="col-12 col-lg-6 p-lg-7 d-none d-lg-flex flex-column justify-content-center overlay overlay-primary overlay-80 bg-cover rounded-left" style="background-image: url(https://landkit.goodthemes.co/assets/img/photos/photo-3.jpg);">
                  ...
                  <div class="col-12 col-lg-6 p-lg-7">
                    <div class="row no-gutters">
                      <div class="col-6">
                        ...
                        <ul class="list mb-5">
                          <li class="list-item">
                            <a class="list-link" href="https://landkit.goodthemes.co/coworking.html">
                              Coworking
                            </a>
                          </li>
                          <li class="list-item mb-1">
                            <a class="list-link" href="https://landkit.goodthemes.co/rental.html">
                              Rental
                            </a>
                          </li>
                          <li class="list-item">
                            <a class="list-link" href="https://landkit.goodthemes.co/job.html">
                              Job Listing
                            </a>
                          </li>
                        </ul>
                        ...
                        <ul class="list mb-0">
                          <li class="list-item">
                            <a class="list-link" href="https://landkit.goodthemes.co/desktop-app.html">
                              Desktop
                            </a>
                          </li>
                          <li class="list-item">
                            <a class="list-link" href="https://landkit.goodthemes.co/mobile-app.html">
                              Mobile
                            </a>
                          </li>
                        </ul>
                      ...
                      <div class="col-6">
                        ...
                        <ul class="list mb-0">
                          <li class="list-item">
                            <a class="list-link" href="https://landkit.goodthemes.co/index.html">
                              Basic
                            </a>
                          </li>
                          <li class="list-item">
                            <a class="list-link" href="https://landkit.goodthemes.co/enterprise.html">
                              Enterprise
                            </a>
                          </li>
                          <li class="list-item">
                            <a class="list-link" href="https://landkit.goodthemes.co/service.html">
                              Service
                            </a>
                          </li>
                          <li class="list-item">
                            <a class="list-link" href="https://landkit.goodthemes.co/cloud.html">
                              Cloud Hosting
                            </a>
                          </li>
                        </ul>
              ...
              <div class="dropdown-menu" aria-labelledby="navbarPages">
                <div class="row no-gutters">
                  <div class="col-6">
                    ...
                    <ul class="list mb-5">
                      <li class="list-item">
                        <a class="list-link" href="https://landkit.goodthemes.co/careers.html">
                          Listing
                        </a>
                      </li>
                      <li class="list-item">
                        <a class="list-link" href="https://landkit.goodthemes.co/career-single.html">
                          Opening
                        </a>
                      </li>
                    </ul>
                    ...
                    <ul class="list mb-0">
                      <li class="list-item">
                        <a class="list-link" href="https://landkit.goodthemes.co/about.html">
                          About
                        </a>
                      </li>
                      <li class="list-item">
                        <a class="list-link" href="https://landkit.goodthemes.co/pricing.html">
                          Pricing
                        </a>
                      </li>
                      <li class="list-item">
                        <a class="list-link" href="https://landkit.goodthemes.co/terms-of-service.html">
                          Terms
                        </a>
                      </li>
                    </ul>               
                  ...
                  <div class="col-6">
                    ...
                    <ul class="list mb-5">
                      <li class="list-item">
                        <a class="list-link" href="https://landkit.goodthemes.co/help-center.html">
                          Overview
                        </a>
                      </li>
                      <li class="list-item">
                        <a class="list-link" href="https://landkit.goodthemes.co/help-center-article.html">
                          Article
                        </a>
                      </li>
                    </ul>
                    ...
                    <ul class="list mb-0">
                      <li class="list-item">
                        <a class="list-link" href="https://landkit.goodthemes.co/contact.html">
                          Basic
                        </a>
                      </li>
                      <li class="list-item">
                        <a class="list-link" href="https://landkit.goodthemes.co/contact-alt.html">
                          Cover
                        </a>
                      </li>
                    </ul>               
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDocumentation">
                ...
                <!-- Item -->
                <a class="d-flex align-items-center text-decoration-none" href="https://landkit.goodthemes.co/docs/index.html">
                ...
                <!-- Item -->
                <a class="d-flex align-items-center text-decoration-none" href="https://landkit.goodthemes.co/docs/alerts.html">
                ...
                <!-- Item -->
                <a class="d-flex align-items-center text-decoration-none" href="https://landkit.goodthemes.co/docs/changelog.html">
        ...
        <div class="row align-items-center justify-content-between mb-8 mb-md-11">
          <div class="col-12 col-md-6 order-md-2" data-aos="fade-left">
            ...
            <h2>
              ...
              <span class="text-success">ever created for <span data-toggle="typed" data-strings='["developers.", "founders.", "designers."]'></span></span>
            </h2>
          ...
          <div class="col-12 col-md-5 col-lg-6">
            ...
            <div class="w-md-150 w-lg-130 position-relative" data-aos="fade-left">
              ...
              <div class="shape shape-fluid-y shape-blur-4 svg-shim text-gray-200">
                <svg viewBox="0 0 803 662" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
          ...
          <div class="col-12 col-md-6">
            ...
            <div class="h-100 d-none d-md-block" data-flickity='{"fade": true, "imagesLoaded": true, "pageDots": false, "prevNextButtons": false, "asNavFor": "#testimonialsCopy", "draggable": false, "setGallerySize": false}'>
              <div class="w-100 h-100">
                ...
                <!-- Image -->
                <div class="w-100 h-100 bg-cover rounded-left" style="background-image: url(assets/img/photos/photo-1.jpg);">
              ...
              <div class="w-100 h-100">
                ...
                <!-- Image -->
                <div class="w-100 h-100 bg-cover rounded-left" style="background-image: url(assets/img/photos/photo-26.jpg);">
